...
public class m_ThirdHit_STAND_A extends Method 
{
	public m_ThirdHit_STAND_A()
	{
		super();
		
		this.name = "m_ThirdHit_STAND_A";
	...
	public boolean CheckPreconditions(Pair<SimCharacter, SimCharacter> currentSimCharacters) 
	{
		...
		{
			Action last = currentSimCharacters.m_a.GetPrevActions().removeLast();
			if(!(currentSimCharacters.m_a.GetPrevActions().getLast() == Action.STAND_A && last == Action.STAND_B))
			{
				holds = false;
			}
			currentSimCharacters.m_a.GetPrevActions().addLast(last);
		}
